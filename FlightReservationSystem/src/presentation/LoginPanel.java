...
public class LoginPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        backButton.setForeground(new Color(85, 107, 47)); // Dark olive
        ...
        emailLabel.setForeground(new Color(60, 60, 50)); // Dark Grey
        gbc.gridx = 0;
        add(emailLabel, gbc);
        ...
        passwordLabel.setForeground(new Color(60, 60, 50)); // Dark Grey
        ...
        loginButton.setBackground(new Color(107, 142, 35)); // Olive Drab
        loginButton.setForeground(new Color(60, 60, 50)); // Dark Grey
        ...
        loginButton.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                loginButton.setBackground(new Color(128, 170, 42)); // Lighter olive
                loginButton.setBorder(BorderFactory.createCompoundBorder(
        ...
        // Switch to Signup (only for CUSTOMER role)
        if (preSelectedRole.equalsIgnoreCase("CUSTOMER")) {
            ...
            switchToSignupButton.setForeground(new Color(107, 142, 35)); // Olive Drab
