...
/**
 * <<boundary>>
 * Flight Search Panel with Sage Green buttons
 */
public class FlightSearchPanel extends JPanel {
    ...
    public FlightSearchPanel(Customer customer) {
    ...
    private void initializeUI() {
        ...
        searchButton.setForeground(SAGE_GREEN);
        ...
        clearButton.setForeground(SAGE_GREEN);
        ...
        bookButton.setBackground(new Color(107, 142, 35));
        bookButton.setForeground(SAGE_GREEN);
    ...
    private void bookFlight() {
        ...
        List<Flight> allFlights = searchController.getAllFlights();
        ...
        BookingDialog dialog = new BookingDialog(parentFrame, customer, selectedFlight);
        dialog.setVisible(true);
        
        // After dialog closes, refresh if booking was successful
        if (dialog.isBookingSuccessful()) {
            loadAllFlights(); // Refresh flight list
        }
    }
}